...
def add_new_point_to_csv(filename, map_name, n_friends, n_enemies, friends_coord, enemies_coord, wall_exists, wall_begins, wall_middle, wall_ends, label):
...
def main():
    ...
    #add_new_point_to_csv(TABLE_FILE_NAME, '2m2mFOX', 2, 2, (1, 1), (10, 1), 0, (2, 2), (4, 2), (8, 2), 'q-learning')
