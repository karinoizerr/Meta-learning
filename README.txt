Алгоритм ReverseExperiment таков:
...
Основной алгоритм:
0. Заполнить датасет через create_dataset.py
1. Разметить данные = обучить агентов на каждой карте каждым алгоритмом. (label_dataset.py)
2. Обучить NeuralNetwork.py